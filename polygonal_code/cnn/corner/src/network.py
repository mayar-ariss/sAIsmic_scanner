...
# ---------------------------------------------- Convolution blocks ----------------------------------------------------
# In the following classes, convolution blocks, which are used in the U-net families of architecture are defined.
...
# ---------------------------------------------- U-net11 Architecture --------------------------------------------------
class U_Net11(nn.Module):
...
# ---------------------------------------------- U-net16 Architecture ----------------------------------------------------
class U_Net16(nn.Module):
    def __init__(
        self,
        num_classes: int = 1,
        num_filters: int = 32,
